...
The request body picks the mode and what to inject into the next session:

```json
{
  "mode": "spoof",                                  // or "fresh"
  "inject_docs": ["telos", "context_payload", "state"],
...
```json
{
  ...
  "injected_docs": ["telos", "context_payload", "state"]
}
```
...
Marketing         [busy]     /path/to/marketing
CPA            [online]   /path/to/cpa
```
