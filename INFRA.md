...
| `SUTRA_AGENT` | `ScratchPad` | Default agent for orchestrator mode |
...
- **Self-dispatch guard** — cannot dispatch to agent "Sutra" via orchestrator (empty response). Default agent is ScratchPad.
