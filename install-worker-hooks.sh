...
WORKERS=(
  "$HOME/Downloads/personal-os-main/Projects/CPA"
...
echo ""
echo "Test with:"
echo "  1. Send a message to a worker agent (e.g., CPA)"
...
echo "  cat ~/Downloads/personal-os-main/Projects/CPA/.claude/hooks/PostToolUse"
